<div>
   <form action="" wire:submit.prevent="uploadblog" enctype="multipart/form-data">
       ...
       <div class="form-group">
           ...
           <textarea wire:model.defer="description" id="" class="form-control" cols="30" rows="10"></textarea>
           @error('description')
               <span class="text-danger">{{ $message }}</span>
           @enderror
       </div>
       ...
       <button type="submit" class="btn btn-lg btn-primary me-3" data-kt-stepper-action="submit">
        <span class="indicator-label">Upload New Blog 

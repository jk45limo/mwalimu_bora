...
<head>
    ...
    <link href="{{ asset('assets/css/parent-forms.css') }}" rel="stylesheet">
        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link active" href="{{ url('parent/') }}">Parents</a></li>
                    ...
                    <li><a class="nav-link" href="{{ url('parent-login') }}">Log In</a></li>
                    <li><a class="nav-link" href="{{ url('parent-register')}}">Sign Up</a></li>
                </ul>
                <i class="bi bi-list mobile-nav-toggle"></i>
            </nav>
            <!-- .navbar -->
            <a href="{{ url('parent-login')}}" class="appointment-btn scrollto"><span class="d-none d-md-inline"
                style="margin-right: 1rem;"></span>
            Login</a>
        <a href="{{ url('parent-register') }}" class="appointment-btn scrollto">
            Sign Up</a>

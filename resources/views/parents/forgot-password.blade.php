...
@section('title','Parent Forgot Password')
@section('content')
           ...
           @csrf
            ...
            <div class="form-wrap row">
                ...
                <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
                    <button type="submit" class="form-next-button">SEND RESET LINK</button>
                </div>
                <p><a href="{{ url('parent-login') }}"><i class="bx bx-chevron-left"></i> Back to Sign In</a></p>
            </div>
        </form>
    </div>
</div>

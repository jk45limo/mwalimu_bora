      ...
      <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <!--end::Wrapper-->
                <!--begin::Button-->
                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app" id="kt_toolbar_primary_button">Create Admin</a>
                <!--end::Button-->
            </div>
            <!--end::Actions-->
        </div>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-xl-stretch">
                        ...
                        <div class="card-header border-0 bg-danger py-5">
                            <h3 class="card-title fw-bolder text-white">School Summary</h3>
                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-warning fw-bold fs-6">Students</a>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-primary fw-bold fs-6">Teachers</a>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-danger fw-bold fs-6 mt-2">New Applications</a>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col bg-light-success px-6 py-8 rounded-2">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-success fw-bold fs-6 mt-2">Students</a>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                    ...
                    <div class="card card-xl-stretch">
                        ...
                        <div class="card-header align-items-center border-0 mt-4">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted fw-bold fs-7">Total - 8</span>
                            </h3>
                            <div class="card-toolbar">
                                <!--begin::Menu-->
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="timeline-label">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <!--end::Badge-->
                                    <!--begin::Text-->
                                    <div class="fw-mormal timeline-content text-muted ps-3">AGM upcoming meeting</div>
                                    <!--end::Text-->
                                </div>
                                <!--end::Item-->
                                <!--begin::Item-->
                                ...
                                <div class="timeline-item">
                                    ...
                                    <!--end::Badge-->
                                    <!--begin::Desc-->
                                    <div class="timeline-content fw-bolder text-gray-800 ps-3">Fee Payment
                                        <a href="#" class="text-primary">700</a>. to student</div>
                                    <!--end::Desc-->
                                </div>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <div class="timeline-item">
                                    ...
                                    <!--end::Badge-->
                                    <!--begin::Text-->
                                    <div class="timeline-content fw-mormal text-muted ps-3">Price giving day</div>
                                    <!--end::Text-->
                                </div>
                                <!--end::Item-->
                                <!--begin::Item-->
                                ...
                                <div class="timeline-item">
                                    ...
                                    <!--end::Badge-->
                                    <!--begin::Text-->
                                    <div class="timeline-content fw-mormal text-muted ps-3">Form 1 admission </div>
                                    <!--end::Text-->
                                </div>
                                <!--end::Item-->
                                <!--begin::Item-->

...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center py-1">
            ...
            <!--end::Wrapper-->
            <!--begin::Button-->
            <a href="{{ route('managetutors.create') }}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">Register New Tutor</a>
            <!--end::Button-->
        </div>
        <!--end::Actions-->
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                @if ($tutors->count() == 0)
                    ...
                    <!--end::Title-->
                    <!--begin::Description-->
                    <p class="text-gray-400 fs-4 fw-bold mb-10">There are no enrolled  tutors yet.
                    <br />Kickstart your tutors page by enrolling your first teacher</p>
                    <!--end::Description-->
                    <!--begin::Action-->
                    <a href="{{ route('managetutors.create') }}" class="btn btn-primary" >Enrol Now</a>
                    <!--end::Action-->
                ...
                @foreach ($tutors as $tutor)
                                ...
                                <tr>
                                    <td>{{ $tutor->tutoruser->name }}</td>
                                    <td>{{ $tutor->phone_number }}</td>
                                    <td>{{ $tutor->username }}</td>
                                    <td>{{ $tutor->tutoruser->email }}</td>
                                    <td>{{ $tutor->referral_code }}</td>
                                    <td>{{ $tutor->created_at->format('l,d-m-y') }}</td>
                                    <td>
                                        <div class="flex justify-content-space-between">
                                            <a href="{{ route('managetutors.show', $tutor->id) }}" class="btn btn-rounded btn-primary btn-sm"><i class="fas fa-eye"></i></a>

...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Teacher Profile</h1>
            <!--end::Title-->
            <!--begin::Separator-->
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin')}}" class="text-muted text-hover-primary">{{ $teacheruser->teacheruser->name}}</a>
                </li>
                <!--end::Item-->
            ...
            <div class="col-lg-4 col-xs-12 col-md-4 col-sm-5">
                <div class="teacher-profile">
                    ...
                    <div class="bottom-teacher-profile">
                        <h3>{{$teacheruser->teacheruser->name}}</h3> 
                        <h4>{{ $teacheruser->subject_combination}}</h4>
                        <h4>{{ $teacheruser->tsc_number}}</h4>
                        <section>
                            <span>{{ $teacheruser->gender}}</span>
                            <span>{{ $teacheruser->phone_number}}</span>
                            <span>{{ $teacheruser->teacheruser->email}}</span>
                            
                            <span>{{ $teacheruser->country}} - {{ $teacheruser->county}}</span>
                        </section>
                        <section class="px-8 py-3 mb-4 text-center">
                            <span>{{ $teacheruser->address}}</span>
                        </section>
                    </div>
                </div>
            </div>

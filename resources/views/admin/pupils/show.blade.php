...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Pupil Profile</h1>
            <!--end::Title-->
            <!--begin::Separator-->
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin')}}" class="text-muted text-hover-primary">{{ $pupil->pupiluser->name}}</a>
                </li>
                <!--end::Item-->
            ...
            <div class="col-lg-4 col-xs-12 col-md-4 col-sm-5">
                <div class="teacher-profile">
                    ...
                    <div class="bottom-teacher-profile">
                        <h3>{{$pupil->pupiluser->name}}</h3> 
                        <h4>{{ $pupil->school_system}}</h4>
                        <h4>{{ $pupil->school_level}}</h4>
                        <section>
                            <span>{{ $pupil->phone_number}}</span>
                            <span>{{ $pupil->pupiluser->email}}</span> 
            ...
            <div class="col-lg-8 col-xs-12 col-md-8 col-sm-7">
                <div class="teacher-profile-content">
                    <ul class="nav nav-pills" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Parent</button>
                        </li>

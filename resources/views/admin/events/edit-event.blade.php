...
@section('content')
    ...
    <div class="p-7">
        <div class="card">
            <form action="{{ route('manageevents.update', $event->id) }}" method="POST" class="mx-4 " autocomplete="off" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="register-step-one">
                    <div class="top-register-step-one py-5">
                        <h5>Event Details</h5>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" type="text" name="start_date"  
                                        class="form-control" placeholder="">
                                        <small class="form-text text-muted">Default set time is {{ $event->start->format('l, d-m-y h:i:s a') }}</small>
                                        @error('start_date')
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" type="text" name="end_date"  
                                        class="form-control" placeholder="">
                                        <small class="form-text text-muted">Default set time is {{ $event->end->format('l, d-m-y h:i:s a') }}</small>
                                        @error('end_date')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <select name="event_for" class="form-control" id="">
                                        <option value="{{ $event->event_for }}">{{ $event->event_for }}</option>
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="venue" value="{{ $event->event_place }}"
                                        class="form-control" placeholder="">
                                    @error('venue')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" value="" class="form-control" id="" cols="30"

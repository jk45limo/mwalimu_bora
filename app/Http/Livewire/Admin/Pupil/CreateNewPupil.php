...
namespace App\Http\Livewire\Admin\Pupil;
...
use Carbon\Carbon;
class CreateNewPupil extends Component
{
    public $first_name;
    public $middle_name;
    public $surname;
    ...
    {
        return view('livewire.admin.pupil.create-new-pupil');
    }
    ...
    public function registerpupil()
    {
        ...
        Toastr::warning('New Pupil Registered Successfully.', 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->route('managepupils.index');
    }
}
